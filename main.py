...
example_pattern = "CKA/GKA - Product brand - End User / Project name - destination country - 123456"
tolerance = 0.477

@app.route('/')
def index():
    return render_template('index.html', elements_tested=elements_tested, last_element=last_element, last_score=last_score, average_score=calculate_average_score(), valid_count=valid_count, invalid_count=invalid_count, all_elements=all_elements)
